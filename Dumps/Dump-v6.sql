...
CREATE TABLE `employee_leaves` (
  ...
  `status_of_leave_asking` enum('Pending','Approved','Rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Pending',
  `request_date` date DEFAULT NULL,
  `approved_by` int DEFAULT NULL,
  `answer_date` date DEFAULT NULL,
  `leave_type` enum('Annual Leave','Health Leave\n','Unpaid Leave\n','Excuse Leave\n') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `special_requests` (
  ...
  `status_of_special_request` enum('Pending','Approved','Rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Pending',
  `approved_by` int DEFAULT NULL,
  `text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `answer_date` date DEFAULT NULL,
...
-- Dump completed on 2024-12-17  1:28:18
