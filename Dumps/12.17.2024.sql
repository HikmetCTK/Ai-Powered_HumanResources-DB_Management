...
--
-- Temporary view structure for view `employee_items_with_names2`
--

DROP TABLE IF EXISTS `employee_items_with_names2`;
/*!50001 DROP VIEW IF EXISTS `employee_items_with_names2`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `employee_items_with_names2` AS SELECT 
 1 AS `employee_id`,
 1 AS `first_name`,
 1 AS `last_name`,
 1 AS `item_id`,
...
--
-- Temporary view structure for view `employee_items_with_names3`
--

DROP TABLE IF EXISTS `employee_items_with_names3`;
/*!50001 DROP VIEW IF EXISTS `employee_items_with_names3`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `employee_items_with_names3` AS SELECT 
 1 AS `employee_id`,
 1 AS `first_name`,
 1 AS `last_name`,
 1 AS `item_id`,
...
INSERT INTO `items` VALUES (1,'hammer',180),(2,'helmet',296),(3,'gloves',66),(4,'safety shoes',567),(5,'Welding Machine',289),(6,'Drill',335),(7,'truck',10),(8,'laptop',200),(9,'Desk',100),(15,'Chip',250);
...
--
-- Final view structure for view `employee_items_with_names2`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `employee_items_with_names2` AS select `e`.`employee_id` AS `employee_id`,`e`.`first_name` AS `first_name`,`e`.`last_name` AS `last_name`,`ei`.`item_id` AS `item_id`,`i`.`item_name` AS `item_name`,`ei`.`assign_id` AS `assign_id`,`ei`.`assignment_date` AS `assignment_date` from ((`employee_items` `ei` join `employees` `e` on((`ei`.`employee_id` = `e`.`employee_id`))) join `items` `i` on((`ei`.`item_id` = `i`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `employee_items_with_names3`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `employee_items_with_names3` AS select `e`.`employee_id` AS `employee_id`,`e`.`first_name` AS `first_name`,`e`.`last_name` AS `last_name`,`ei`.`item_id` AS `item_id`,`i`.`item_name` AS `item_name`,`ei`.`assign_id` AS `assign_id`,`ei`.`assignment_date` AS `assignment_date` from ((`employee_items` `ei` join `employees` `e` on((`ei`.`employee_id` = `e`.`employee_id`))) join `items` `i` on((`ei`.`item_id` = `i`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-12-17 19:31:26
