...
INSERT INTO `items` VALUES (1,'hammer',180),(2,'helmet',300),(3,'gloves',70),(4,'safety shoes',567),(5,'Welding Machine',289),(6,'Drill',335),(7,'truck',10),(8,'laptop',200),(9,'Desk',100),(15,'Chip',250);
...
INSERT INTO `messages` VALUES (1,1,2,'Hello, this is a test message!',0,'2024-11-26 20:30:34',NULL),(2,2,3,'Reminder for the team meeting tomorrow.',0,'2024-11-26 20:30:34',NULL),(3,3,4,'this is for testing11',0,'2024-11-27 00:06:46',NULL),(4,3,5,'this is for testing11',0,'2024-11-27 00:06:46',NULL),(5,3,6,'this is for testing11',0,'2024-11-27 00:06:46',NULL),(6,3,7,'this is single message attempting',0,'2024-11-27 00:07:24',NULL),(7,3,7,'this is single message attempting',0,'2024-11-27 00:18:44',NULL),(10,3,8,'this is single message attempting',0,'2024-11-27 00:34:44',NULL),(19,3,8,'this is single message attempting2',0,'2024-12-03 00:56:01','acil!!'),(20,3,4,'this is single message attempting2',0,'2024-12-03 00:56:01','acil!!');
...
/*!50001 VIEW `employee_items_with_names` AS select `e`.`employee_id` AS `employee_id`,`e`.`first_name` AS `first_name`,`e`.`last_name` AS `last_name`,`ei`.`item_id` AS `item_id`,`i`.`item_name` AS `item_name`,`ei`.`assign_id` AS `assign_id`,`ei`.`assignment_date` AS `assignment_date` from ((`employee_items` `ei` join `employees` `e` on((`ei`.`employee_id` = `e`.`employee_id`))) join `items` `i` on((`ei`.`item_id` = `i`.`id`))) order by `ei`.`assign_id` */;
...
-- Dump completed on 2024-12-16 11:48:05
